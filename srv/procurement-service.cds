...
service ProcurementService @(path: '/procurement') {
    ...
    actions {
        ...
        action resubmit() returns {
            status : String;
            message : String;
        };
 
        action markOrdered(referenceNumber : String(50)) returns {
            status : String;
            message : String;
        };
 
        action receiveGoods(notes : String(500)) returns {
            status : String;
            message : String;
    ...
    // Unbound actions
    action bulkApprove(poIds : array of UUID) returns {
        approved : Integer;
        failed : Integer;
    };
    ...
    function getLowStockProducts(threshold : Integer)
        returns array of {
            productName : String;
            stock : Integer;
            minStock : Integer;
